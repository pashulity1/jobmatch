...
const GREENHOUSE_COMPANIES = [
  "vercel", "labelbox", "planetscale", "nexus", "descript", "fastly",
  "veracode", "netlify", "snorkelai", "circleci", "jfrog", "newrelic",
  "figma", "gitlab", "pagerduty", "anthropic", "cloudflare", "datadog",
  "postman", "mixpanel", "lattice", "gusto", "make", "greenhouse",
  "dropbox", "contentful", "intercom", "airtable", "klaviyo", "stripe",
  "algolia", "storyblok", "adyen", "vonage", "twilio", "asana",
  "launchdarkly", "mattermost", "amplitude", "okta", "mercury", "zwift",
  "gemini", "masterclass", "discord", "coinbase", "brex", "robinhood",
  "instacart", "smartsheet", "coursera", "airbnb", "peloton", "udemy",
  "pandadoc", "bird", "calm", "duolingo", "reddit", "lyft", "fourkites",
  "stockx", "climateai", "cerebral", "faire", "veracyte", "talkspace",
  "opendoor", "solarwinds", "fivetran", "flexport", "palmetto", "marqeta",
  "oscar", "chime", "motive", "affirm", "blend", "lithic", "watershed",
  "khanacademy", "netskope", "linkedin", "axios", "udacity", "workato",
  "buzzfeed", "roofstock", "consensys", "getyourguide", "zscaler",
  "lookout", "sweetgreen", "sisense", "roblox", "samsara", "knock",
  "databricks", "ghost", "project44", "nuro", "scopely", "figure",
  "waymo", "kodiak", "medium", "pinterest", "squarespace", "webflow",
  "n26", "pubnub", "sendbird", "nubank", "monzo", "alpaca", "mongodb",
  "yugabyte", "elastic", "bandwidth", "neo4j", "ses", "honeycomb",
  "hootsuite", "later", "crisp", "zuora", "calendly", "remote", "descope",
  "twitch", "warp", "axiom", "ark", "apollo", "clutch", "hackerrank",
  "gocardless", "realm", "singlestore", "zencoder", "smartasset", "clever",
  "submittable", "radar", "goldbelly", "lob", "abacus", "weave", "checkr",
  "clear", "cheddar", "hive", "usergems", "oklo", "qventus", "tempo",
  "sirum", "seed", "flip", "reach", "givecampus", "xendit", "fetch",
  "instawork", "bitmovin", "outschool", "truebill", "paystack", "apolloio",
  "astranis", "billiontoone", "legalist", "pursuit", "pulse", "tetra",
  "firsthand", "aon3d", "nanonets", "upkeep", "aclu", "roofr", "tesseract",
  "assemblyai", "squad", "pelago", "groww", "observeai", "veriff",
  "swayable", "snackpass", "papa", "prodigal", "grin", "momentus",
  "enveritas", "kalshi", "postscript", "nabis", "cocoon", "caribou",
  "glide", "pronto", "odeko", "embrace", "prolific", "revel", "recidiviz",
  "hightouch", "laika", "pulley", "ophelia", "pantheon", "haven", "cortex",
  "able", "powerx", "send", "syncro", "momence", "mesh", "carbonchain",
  "albedo", "noble", "camp", "seer", "galaxy", "ziina", "prospa", "gigs",
  "regent", "marqvision", "journey", "coast", "dots", "baubap", "luminate",
  "beam", "agency", "spade", "attain", "alma", "raven", "axle", "shelf",
  "reflex", "alloy", "extend", "edge", "diligent", "affinity", "flex",
  "momentic", "newton", "paradigm", "parallel", "hazel", "plume", "sensei",
  "starcloud", "quetzal", "symphony", "sunset", "osmosis", "strike",
  "retrofit", "candid", "attune", "zero", "burnt", "iris", "nucleo",
  "icarus", "maven", "resonate",
];

const ASHBY_COMPANIES = [
  "affirm", "watershed", "ghost", "runway", "neon", "readme", "railway",
  "modal", "anyscale", "linear", "render", "sentry", "perplexity",
  "supabase", "docker", "cohere", "mistral", "elevenlabs", "helpscout",
  "clerk", "column", "sanity", "livekit", "unit", "notion", "zapier",
  "posthog", "strava", "clickup", "n8n", "xero", "ashby", "ramp",
  "stytch", "deel", "leapsome", "workos", "plaid", "opensea", "quicknode",
  "moderntreasury", "babbel", "patreon", "substack", "airbyte", "poshmark",
  "drata", "whatnot", "foundation", "vanta", "spotdraft", "orca",
  "snowflake", "abound", "kira", "alchemy", "elliptic", "confluent",
  "quora", "supercell", "hopper", "close", "stream", "dave", "vultr",
  "redis", "bunny", "fullstory", "influxdata", "nomad", "buffer", "crisp",
  "paddle", "pleo", "plane", "mural", "resend", "openai", "warp",
  "inngest", "axiom", "fig", "windmill", "eventual", "continue", "cursor",
  "gitbook", "gamma", "mintlify", "dash0", "oyster", "rescale",
  "circuithub", "velocity", "tilt", "clerky", "sift", "tremendous",
  "healthsherpa", "benchling", "padlet", "radar", "cambly", "snapdocs",
  "weave", "backpack", "permutive", "tenjin", "bankjoy", "tempo",
  "cinder", "meadow", "new-story", "assembly", "shasqi", "verge-genomics",
  "reach", "mux", "deepgram", "castle", "gecko-robotics", "silver",
  "boom", "vetcove", "pursuit", "miso", "speak", "classdojo", "pearl",
  "scribe", "rezi", "pulse", "armory", "clipboard", "mednet", "firsthand",
  "breaker", "upcodes", "prelim", "newfront", "headstart", "spellbrush",
  "promise", "squad", "skip", "ben", "replit", "snackpass", "revenuecat",
  "titan", "duffel", "corvus-robotics", "mutiny", "skydropx", "overview",
  "parker", "kalshi", "golinks", "middesk", "hatch", "switchboard",
  "doppler", "fuse", "caribou", "glide", "verto", "atlas", "playground",
  "dex", "prompt", "sable", "trm-labs", "tandem", "rutter", "compound",
  "hightouch", "freshpaint", "flux", "vorticity", "deepnote", "curri",
  "motion", "paragon", "odin", "accord", "phonic", "ladder", "handoff",
  "ditto", "glimpse", "benepass", "ello", "multiverse", "vori", "savvy",
  "photoroom", "junction", "upflow", "tajir", "thndr", "stable", "belvo",
  "roboflow", "lightdash", "luminai", "zip", "atob", "novel", "atomic",
  "yotta", "blissway", "omni", "stacker", "notabene", "kingdom",
  "hotplate", "farel", "flint", "arketa", "ready", "formal", "taktile",
  "finch", "fieldguide", "atrato", "abacum", "signoz", "humaans",
  "authzed", "spruceid", "encord", "axle-health", "finary", "faction",
  "firstbaseio", "camber", "anima", "vapi", "fathom", "popl", "liveflow",
  "homebase", "enode", "hudu", "simplify", "topline-pro", "fable",
  "phoenix", "infracost", "flutterflow", "ziina", "svix", "regent",
  "blink", "shepherd", "h3x-technologies", "slope", "pipekit",
  "odys-aviation", "replo", "level", "parallel-bio", "confido", "double",
  "lago", "hypercore", "tavus", "kodex", "onebrief", "bree", "formance",
  "lemfi", "oneschema", "aleph", "meticulous", "float", "adaptyv",
  "mach9", "pylon", "malga", "birdie", "turion-space", "stepful",
  "aviator", "exa", "charge-robotics", "toku", "nash", "agave", "sieve",
  "aspora", "invert", "happl", "beam", "lancedb", "bifrost", "complete",
  "skylink", "sphere", "permitflow", "posh", "voize", "fleek", "govdash",
  "tailor", "julius", "two-dots", "mercator", "craze", "novig",
  "boostly", "juicebox", "stellar", "blee", "thera", "unify", "pivot",
  "metriport", "bitstack", "aurelian", "ekho", "quindar", "aiprise",
  "kombo", "firecrawl", "oneleet", "knowtex", "cambio", "capsule",
  "finvest", "avoca", "infisical", "rollstack", "nango", "concourse",
  "latent", "numeral", "tennr", "salient", "goveagle", "coperniq",
  "vooma", "pirros", "cosine", "bluedot", "relace", "langfuse", "extend",
  "inkeep", "honeydew", "vitalize", "echo", "loula", "keep", "invopop",
  "vellum", "conduit", "vector", "finni-health", "litellm", "escape",
  "artie", "automat", "hockeystack", "twenty", "hyperbound", "casca",
  "campfire", "airgoods", "subsets", "terminal", "outset", "fleetworks",
  "fortuna-health", "glade", "sola", "safetykit", "langdock", "sweep",
  "pure", "onyx", "healthtech-1", "gumloop", "momentic", "greptile",
  "reducto", "tuesday-lab", "garage", "greenboard", "paradigm", "furtherai",
  "artisan", "pointone", "arini", "parallel", "clarion", "centralize",
  "astro-mechanica", "hazel", "offdeal", "raindrop", "focal",
  "circleback", "retell-ai", "polar", "aqua-voice", "datacurve", "forge",
  "ultra", "blacksmith", "doublezero", "spherecast", "mem0",
  "codes-health", "phonely", "claimsorted", "modus", "kastle", "substrate",
  "conveo", "anara", "saturn", "vibe", "david-ai", "zeit-ai", "simple-ai",
  "pharos", "usul", "conductor", "telli", "archil", "ctgt", "sphinx",
  "capy", "innate", "sunset", "apolink", "ryvn", "flowtel", "bild-ai",
  "mosaic", "salespatriot", "hud", "solidroad", "infinite", "afterquery",
  "cedar", "butter", "mercura", "chestnut", "ambral", "blaxel",
  "claim-health", "minerva", "auctor", "sim", "lucis", "lapel", "zero",
  "sygaldry-technologies", "airweave", "prox", "truthsystems", "mangodesk",
  "agentmail", "lark", "bootloop", "doe", "interface", "flai", "fulcrum",
  "solva", "finto", "april", "idler", "fernstone", "opennote", "fleetline",
  "kernel", "reacher", "nox-metals", "hyperspell", "uplane", "sf-tensor",
  "primer", "diligencesquared", "moss", "corvera", "lance", "stilta",
  "pax-historia", "traverse", "polymath", "maven",
];
